 ...
 */
package com.freak.httphelper.delegate;
...
public interface IActivity {
     ...
     * 如果返回{@code false},那意味着这个 Activity 不需要绑定 Fragment,那你再在这个 Activity 中绑定继承于 {@link com.freak.httphelper.delegate.base.BaseDaggerMvpFragment} 的 Fragment 将不起任何作用
